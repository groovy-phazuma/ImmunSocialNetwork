...
from network_models.my_estimator.dist_type import DistTypeContinuous, dist_type_aliases
from network_models.my_estimator.structuremodel import StructureModel
